...
! function () {
    ...
    a.dev = !1, a.tooltip = a.tooltip || {}, a.utils = a.utils || {}, a.models = a.models || {}, a.charts = {}, a.logs = {}, a.dom = {}, "undefined" != typeof module && "undefined" != typeof exports && "undefined" == typeof d3 && (d3 = require("d3")), a.dispatch = d3.dispatch("render_start", "render_end"), Function.prototype.bind || (Function.prototype.bind = function (a) {
        ...
        var d = "nvtooltip-" + Math.floor(1e5 * Math.random()),
            ...
            u = function (a, b) {
                ...
                var e = c.selectAll("tbody").data([a]).enter().append("tbody"),
                    f = e.selectAll("tr").data(function (a) {
                        return a.series
        ...
        function b(a) {
            var b = a.sort(d3.ascending),
                c = 1.349,
                d = (d3.quantile(b, .75) - d3.quantile(b, .25)) / c;
        ...
        function d(a) {
            function b(a, b) {
                var d = a.map(function (a) {
                    ...
                    m = {
                        ...
                        minmax: d3.min(d),
                        stddev: d3.mean(d) - d3.deviation(d)
                    },
                    n = {
                ...
                var s = e(g(r), x.ticks(Y)),
                    t = X ? f(s(d), d3.extent(d)) : s(d),
            ...
            if (R) {
                ...
                for (var i = h.map(function (a) {
                    ...
                    for (var l = 0; l < da.length; l++) j.push(i[k] + "_" + da[l]);
        ...
        function f(a, b) {
            ...
            return b[0] < c[0].x && c.unshift({
                x: b[0],
                y: c[0].y
            }), b[1] > c[c.length - 1].x && c.push({
                x: b[1],
                y: c[c.length - 1].y
            }), c
        }
        ...
        function j(b) {
            return ga.reset(), b.each(function (b) {
                ...
                e.attr("transform", function (a) {
                    ...
                    var c = d3.select(this),
                        d = "box" == k ? h(y(), F(), v(), a) : a.values.kde;
                    c.selectAll("path").datum(d);
                    var e = ea[b],
                        g = "box" == k ? "linear" : "basis";
                    ...
                    if (0 != d3.select(this).style("opacity")) {
                        ...
                        d3.select(this).classed("hover", !0), aa.elementMouseover({
                            ...
                            series: {
                                key: "mean" == S ? G(a).toFixed(2) : C(a).toFixed(2),
                                color: d
                            },
                            e: d3.event
                        })
                ...
                W.append("circle").style({
                    opacity: 0
                }), W.append("line").style("stroke-width", 1).style({
                    ...
                    var d = d3.select(this),
                        e = d3.select(this.parentNode).style("fill");
        ...
        var k, l, m, n, o, p, q, r, s = {
            ...
            Y = 50,
            Z = 3,
            $ = a.utils.defaultColor(),
            _ = null,
            aa = d3.dispatch("elementMouseover", "elementMouseout", "elementMousemove", "renderEnd"),
            ba = 250,
            ca = null,
            da = d3.set(),
            ea = [],
            fa = [],
            ga = a.utils.renderWatch(aa, ba);
        ...
        function c(a, b) {
            ...
            for (var c = a.length; c--;)
                if ("object_constancy" in a[c] && delete a[c].object_constancy, "object_constancy" in b[c] && delete b[c].object_constancy, !d(a[c], b[c])) return !1;
            return !0
        }
        ...
        var f, g, h = a.models.distroPlot(),
            ...
            u = a.models.tooltip(),
            v = "No Data Available.",
            w = d3.dispatch("stateChange", "beforeUpdate", "renderEnd"),
            x = 500;
        ...
        function h(a) {
            ...
            if (-1 != b.indexOf(P)) {
                var e = (Object.keys(aa), Object.keys(ba), P.includes("Scale") ? !0 : !1),
                    ...
                    h = P.includes("Row") ? "row" : P.includes("Column") ? "col" : null,
                    i = c(a, h),
                    j = {},
                    k = {};
                ...
                a.forEach(function (a, b) {
                    if (g()) {
                        if ("row" == h) var c = ka(a);
                        else if ("col" == h) var c = ja(a);
                        else if (null == h) var c = 0;
                        var d = J(a) - j[c];
            ...
            return ga.reset(), c.each(function (c) {
                ...
                L.watchTransition(ga, "heatMap: xMetaRect").attr("width", z - O).attr("height", Y()).attr("transform", function (a, b) {
                    ...
                    var c = (d3.select(this).select("rect").node().getBBox(), d3.mouse(d3.select(".nv-heatMap").node())),
                        e = c[0],
                        f = c[1];
                    (e + O >= d || f + O >= h || 0 > e || 0 > f) && (k(), W.elementMouseout({
                        e: d3.event
                    }))
                }).on("mousemove", function (a, b) {
                    W.elementMousemove({
                    ...
                    var c = -1 != d3.select(this).attr("class").indexOf("x-meta") ? !0 : !1,
                        ...
                        f = e[0],
                        g = e[1];
                    (0 > g || 0 > f || c && f + O >= d || !c && g + O >= h) && (k(), W.elementMouseout({
                        e: d3.event
                    }))
                }).on("mousemove", function (a, b) {
                    W.elementMousemove({
        ...
        function e(j) {
            return A.reset(), A.models(h), A.models(k), A.models(l), j.each(function (j) {
                var n = d3.select(this);
                a.utils.initSVG(n);
                var x = a.utils.availableWidth(o, n, m),
                    B = a.utils.availableHeight(p, n, m);
                ...
                var C = n.selectAll("g.nv-wrap").data([j]),
                    D = C.enter().append("g").attr("class", "nvd3 nv-wrap").append("g"),
                    E = C.select("g");
                ...
                var N = b().map(function (a) {
                    return Array.isArray(a) ? {
                        key: a[0].toFixed(1) + " - " + a[1].toFixed(1)
                    } : {
                        key: a
                    }
                });
        ...
        var f, g, h = a.models.heatMap(),
            i = a.models.legend(),
            j = (a.models.legend(), a.models.legend(), a.models.tooltip()),
            k = a.models.axis(),
            l = a.models.axis(),
            m = {
                top: 20,
            ...
            w = 0,
            x = null,
            y = d3.dispatch("beforeUpdate", "renderEnd"),
            z = 250;
        ...
        function b(e) {
            return s.reset(), s.models(c), e.each(function (e) {
                ...
                } else "bottom" === l && (d.width(m).key(c.x()), s.select(".nv-legendWrap").datum(e).call(d), f.bottom = d.height(), p = a.utils.availableHeight(i, j, f), s.select(".nv-legendWrap").attr("transform", "translate(0," + p + ")"));
        ...
        function e(b) {
            return Z.reset(), b.each(function (b) {
                ...
                var ba = "function" == typeof e.yScale().base,
                    ca = M && N && Q ? [] : d3.merge(b.map(function (a) {
                        return a.values.map(function (a, b) {
                            return {
                                x: x(a, b),
                                y: y(a, b),
